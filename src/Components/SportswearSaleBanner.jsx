...
const SportswearSaleBanner = () => {
  return (
    ...
    >
      {/* Left Arrow */}
      <button className="absolute left-4 top-1/2 transform -translate-y-1/2 bg-white p-3 rounded-full shadow-md hidden md:block">
      ...
      <div className="relative flex flex-col md:flex-row items-center w-full justify-between">
        ...
        {/* Image */}
        <div className="relative w-full md:w-1/3 flex justify-center md:justify-end items-end">
          <img
            src={girlPic}
      ...
      {/* Right Arrow */}
      <button className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-white p-3 rounded-full shadow-md hidden md:block">
