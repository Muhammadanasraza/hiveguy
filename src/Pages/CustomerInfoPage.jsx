...
import PaymentDialog from "../Components/ui/PayMethodDialog"
...
export default function CutomerInfoPage() {
  ...
  const [selectedPaymentForDialog, setSelectedPaymentForDialog] = useState("")
          ...
          <div className="space-y-6  ">
            ...
            <div className="container mx-auto px-4 py-8">
                  ...
                  {[
                    ...
                    <label
                      ...
                      onClick={() => {
                        ...
                        setSelectedPaymentForDialog(payment.id)
              ...
              <PaymentDialog
                ...
                paymentMethod={selectedPaymentForDialog}
              />
            </div>
